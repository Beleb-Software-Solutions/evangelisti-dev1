...
export type Group322IconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function Group322Icon(props: Group322IconProps) {
  ...
  return (
    ...
    >
      ...
      <path stroke={"currentColor"} d={"M18 11.5h47"}></path>
    </svg>
  );
}

export default Group322Icon;
/* prettier-ignore-end */
