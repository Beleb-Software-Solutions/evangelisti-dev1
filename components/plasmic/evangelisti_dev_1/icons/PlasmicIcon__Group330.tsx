...
export type Group330IconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function Group330Icon(props: Group330IconProps) {
  ...
  return (
    ...
    >
      ...
      <path stroke={"currentColor"} d={"M16 11.5h138"}></path>
    </svg>
  );
}

export default Group330Icon;
/* prettier-ignore-end */
