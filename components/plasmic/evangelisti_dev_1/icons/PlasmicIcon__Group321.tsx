...
export type Group321IconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function Group321Icon(props: Group321IconProps) {
  ...
  return (
    ...
    >
      ...
      <path stroke={"currentColor"} d={"M16 11.5h32"}></path>
    </svg>
  );
}

export default Group321Icon;
/* prettier-ignore-end */
