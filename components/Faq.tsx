...
import {
  PlasmicFaq,
  DefaultFaqProps
} from "./plasmic/evangelisti_dev_1/PlasmicFaq";
...
function Faq_(props: FaqProps, ref: HTMLElementRefOf<"div">) {
  ...
  return <PlasmicFaq frame515={{ ref }} {...props} />;
}

const Faq = React.forwardRef(Faq_);
export default Faq;
